...
class ProductService extends Model
{
    ...
    // Set default value for SKU if not provided


    public function SalePrice($value)
    {
        $this->attributes['sale_price'] = !empty($value) ? $value : 0;
    }

    public function setSkuAttribute($value)
    {
        $this->attributes['sku'] = !empty($value) ? $value : 'N/A';
    }
    ...
    {
        return $this->belongsTo(ProductLocation::class, 'productlocation_id');
    }
}
