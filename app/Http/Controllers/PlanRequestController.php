...
class ProductServiceController extends Controller
{
    ...
    public function create()
    {
        if (\Auth::user()->can('create product & service')) {
            ...
            $defaultIncomeAccount = 1170; // Is 1170 a real ID in your income accounts list?

            return view('productservice.create', compact('category', 'unit', 'tax', 'customFields', 'incomeChartAccounts', 'incomeSubAccounts', 'expenseChartAccounts', 'expenseSubAccounts', 'defaultIncomeAccount'));
        } else {
    ...
    public function additem()
    {
        if (\Auth::user()->can('create product & service')) {
            ...
            $defaultIncomeAccount = 1170; // Default income account ID for pre-selection
            $defaultExpenseAccount = 1179; // Default expense account ID for pre-selection

            return view('productservice.additem', compact('category', 'unit', 'tax', 'customFields', 'incomeChartAccounts', 'incomeSubAccounts', 'expenseChartAccounts', 'expenseSubAccounts', 'defaultIncomeAccount', 'defaultExpenseAccount'));
        } else {
            return response()->json(['error' => __('Permission denied.')], 401);
        }
    }
