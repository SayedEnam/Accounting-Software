...
<script type="text/javascript">
    ...
    var stripe = Stripe('{{ $company_payment_setting['
        stripe_key '] }}');
    ...
    $(document).on("click", "#pay_with_flaterwave", function() {
        $('#flaterwave-payment-form').ajaxForm(function(res) {
            ...
            if (res.flag == 1) {
                ...
                var amount = res.total_price;
                var API_publicKey = '{{ $company_payment_setting['
                ...
                <div class="table-responsive">
                    <table class="table ">
                        ...
                        <tr>
                            ...
                            <td class="">
                                {{ Utility::priceFormat($company_setting, $creditNote->amount) }}
                            </td>
