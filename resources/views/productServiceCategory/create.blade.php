...
{{ Form::open(['route' => 'product-category.store', 'class'=>'needs-validation ajax-form-submit','novalidate']) }}
...
<script>
    $(document).on('change', '.cattype', function() {
        ...
        $.ajax({
            // ✨ FIX: Corrected the route() call to be on one line without spaces
