...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-3 quantity d-block  {{$productService->type=='Service' ? 'd-none':''}}">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-4">
            {{ Form::label('productlocation_id', __('Product Location'), ['class' => 'form-label']) }}<x-required></x-required>
            {{ Form::select('productlocation_id', $productLocations, null, ['class' => 'form-control select', 'required' => 'required']) }}
