...
{{ Form::open(['route' => 'productlocation.store','class'=>'needs-validation ajax-form-submit','novalidate']) }}
    ...
    <div class="row">
        ...
        <div>
            <a href="#" data-size="md" data-ajax-popup-over="true"
                data-url="{{ route('generate', ['productlocation']) }}" data-bs-toggle="tooltip" data-bs-placement="top"
        ...
        <div class="form-group col-sm-4">
            {{ Form::label('name', __('Location Name'), ['class' => 'form-label']) }}<x-required></x-required>
            {{ Form::text('name', '', ['class' => 'form-control', 'required' => 'required', 'placeholder'=>__('Enter Location Name')]) }}
        </div>
        <div class="form-group col-sm-4">
