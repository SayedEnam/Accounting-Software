...
<form method="POST" action="{{ route('register.store', ['plan' => $plan]) }}" class="needs-validation" novalidate>
    ...
    <div class="">
        ...
        <div class="form-group">
            <label for="name"
                class="form-label d-flex align-items-center justify-content-between">{{ __('Company Name') }}</label>
            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                value="{{ old('name') }}" placeholder="{{ __('Enter Your Company Name') }}" required autocomplete="name" autofocus>
            @error('name')
        ...
        <!-- START: Mobile Number Field -->
        <div class="form-group">
            <label for="mobile_number" class="form-label">{{ __('Mobile Number') }}</label>
            <input type="hidden" name="country_code" id="country_code"></br>
            <input id="mobile_number" type="tel" class="form-control @error('mobile_number') is-invalid @enderror" name="mobile_number" value="{{ old('mobile_number') }}" placeholder="{{ __('Enter Your Mobile Number') }}" required>
            @error('mobile_number')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
