...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::get('/productservice/additem', [ProductServiceController::class, 'additem'])->name('productservice.additem')->middleware(['auth', 'XSS']);
    Route::get('productservice/productlocation', [ProductServiceController::class, 'productlocation'])->name('productservice.productlocation')->middleware(['auth', 'XSS']);

    //add product location
    Route::get('/productservice/addproductlocation', [ProductServiceController::class, 'addproductlocation'])->name('productservice.addproductlocation')->middleware(['auth', 'XSS']);


    //Post Method Product Location
    Route::post('productlocation', [ProductServiceController::class, 'storeProductLocation'])
        ->name('productlocation.store')
        ->middleware(['auth', 'XSS']);
    // Edit Product Location
    Route::get('productlocation/{id}/edit', [ProductServiceController::class, 'editProductLocation'])
        ->name('productlocation.edit')
        ->middleware(['auth', 'XSS']);
    // Update Product Location
    Route::post('productlocation/{id}/update', [ProductServiceController::class, 'updateProductLocation'])
        ->name('productlocation.update')
        ->middleware(['auth', 'XSS']);
    // Delete Product Location
    Route::delete('productlocation/{id}/destroy', [ProductServiceController::class, 'destroyProductLocation'])
        ->name('productlocation.destroy')
        ->middleware(['auth', 'XSS']);
